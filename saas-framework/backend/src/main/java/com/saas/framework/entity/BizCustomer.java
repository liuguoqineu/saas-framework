 ...
 *
 * 业务类型两级分类：
 *   一级(businessCategory): 加气站类/商业用气/民业用气
 *   二级(businessType): CNG加气站/LPG加气站/餐饮类/团餐类/其他商业类/大型/中型/小型
 *
 * 合作状态(cooperationStatus): 正常履约/终止合作/高潜力/中潜力/低潜力/无效客户
 */
@Data
...
public class BizCustomer {
    ...
    /** 是否无效: 0-正常, 1-无效（冗余字段，业务逻辑统一使用 cooperationStatus="无效客户" 判断） */
    @TableField(exist = false)
